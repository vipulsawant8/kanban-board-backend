...
Backend API for a Kanban Board application, built with Node.js, Express, and MongoDB.

This service manages authentication, lists, and tasks, using a cookie-based session model with access and refresh token rotation.
